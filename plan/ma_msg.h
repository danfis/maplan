...
#define PLAN_MA_MSG_HEUR_LM_CUT_CUT_RESPONSE 0x70
#define PLAN_MA_MSG_HEUR_LM_CUT_MAX_INC_REQUEST 0x08
#define PLAN_MA_MSG_HEUR_LM_CUT_GOAL_ZONE_REQUEST 0x09
#define PLAN_MA_MSG_HEUR_LM_CUT_GOAL_ZONE_RESPONSE 0x90
